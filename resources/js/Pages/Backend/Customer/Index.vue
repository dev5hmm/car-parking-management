            ...
            <div class="card">
                <div class="card-body">
                    <vue-good-table
                        ...
                        :columns="columns"
                        :rows="customers.data"
                        :totalRows="customers.meta.total"
                    >
                        <template #table-row="props">
                        <!-- Action Column -->
                        <div v-if="props.column.field == 'actions'">
                            <Link :href="route('customers.edit', {customer: props.row.id})" >
    ...
    data() {
        return {
            ...
            options: {
                enabled: true,
                mode: "pages",
                perPage: this.customers.meta.per_page,
                setCurrentPage: this.customers.meta.current_page,
