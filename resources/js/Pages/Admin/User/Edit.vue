                ...
                <div class="card-body">
                    <div class="my-6 w-3/4">
                        ...
                        <div class="w-3/4 flex flex-col mb-6">
                            ...
                            <input type="password" id="password" v-model="form.password" class="font-light text-gray-500">
                            <small id="password-help" v-if="errors.password" class="text-red-400">{{ errors.password }}</small>
                        </div>
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.patch(route('admin.users.update', {id: this.user.data.id}), this.form)
        }
    }
}
